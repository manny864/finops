CREATE TABLE IF NOT EXISTS AzureContentSafetySnapshots (
  ...
  usage_textAnalyses BIGINT DEFAULT 0,
  usage_imageAnalyses BIGINT DEFAULT 0,
  usage_blocklistSize BIGINT DEFAULT 0,
