...
- **Azure Advisor:** Sincronización directa con las recomendaciones nativas de Microsoft Azure, clasificadas por Costo, Seguridad, Confiabilidad, Rendimiento y Excelencia Operativa. Las recomendaciones se muestran en el idioma activo seleccionado por el usuario en la plataforma.
  ...
  - **Comportamiento en la Plataforma:** La recomendación desaparece inmediatamente de las listas activas de Optimización y deja de contar como pendiente en el **Índice de Optimización (COIN)** y en el total de ahorro potencial. Al expirar el plazo (30 o 90 días), la plataforma la reabre automáticamente si el recurso sigue desoptimizado.
  - **Aclaración sobre el Portal de Azure:** 
    - *De Azure a la Plataforma:* Si suprimes una recomendación directamente en el Portal de Azure, la plataforma la detecta automáticamente y la oculta en nuestra interfaz.
    - *De la Plataforma a Azure:* Cuando suprimes o descartas desde la plataforma FinOps, la acción se gobierna y audita internamente en la base de datos del tenant bajo el principio de menor privilegio (sin exigir permisos de escritura en Azure). Por ello, en el Portal nativo de Azure la recomendación podría continuar visible, mientras que en la plataforma FinOps queda formalmente suprimida, auditada y fuera de los cálculos de ahorro.
