...
/**
 * GET /api/intelligence/network/internet-access
 * Returns Internet Access & Perimeter Security inventory, cost breakdown, and FinOps leak remediations.
 */
export async function GET(request: NextRequest): Promise<NextResponse> {
    try {
        ...
        if (isMock) {
            const mockData = await getAzureInternetAccess(tenantId);
        ...
        const liveData = await getAzureInternetAccess(tenantId);
