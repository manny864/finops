...
async function processExecutiveReportJob(params: {
    ...
    try {
        ...
        await createNotification({
            ...
            titleKey: "notif_report_ready_title",
            messageKey: "notif_report_ready_msg",
            params: { scope: scopeSubscriptionName },
            href: reportHref,
            severity: "info",
        ...
        if (sendEmailToRequester) {
            try {
                ...
                await createNotification({
                    ...
                    titleKey: "notif_report_ready_no_email_title",
                    messageKey: "notif_report_ready_no_email_msg",
                    params: { error: emailMsg },
                    href: reportHref,
                    severity: "warning",
                    source: "executive-report",
                });
        ...
        await createNotification({
            ...
            titleKey: "notif_report_failed_title",
            messageKey: "notif_report_failed_msg",
            params: { scope: scopeSubscriptionName },
            href: reportHref,
            severity: "warning",
            source: "executive-report",
