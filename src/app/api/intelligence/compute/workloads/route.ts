...
export async function GET(request: NextRequest) {
    try {
                        ...
                        remediationActions: [
                            {
                                ...
                                titleKey: "rec_vmss_rightsizing_title",
                                descKey: "rec_vmss_rightsizing_desc",
                                params: { cpu: 8.4 },
                        ...
                        remediationActions: [
                            {
                                ...
                                titleKey: "rec_vmss_autoscale_title",
                                descKey: "rec_vmss_autoscale_desc",
                                params: { capacity: 3 },
                        ...
                        remediationActions: [
                            {
                                id: "rec-spot-3",
                                type: "spot" as const,
                                titleKey: "rec_vmss_spot_title",
                                descKey: "rec_vmss_spot_desc",
                        ...
                        remediationActions: [
                            {
                                id: "rec-ahub-4",
                                type: "ahub" as const,
                                titleKey: "rec_vmss_ahub_title",
                                descKey: "rec_vmss_ahub_desc",
                        ...
                        remediationActions: [
                            {
                                ...
                                titleKey: "rec_vmss_os_disk_title",
                                descKey: "rec_vmss_os_disk_desc",
                        ...
                        remediationActions: [
                            {
                                ...
                                titleKey: "rec_appsvc_app_packing_title",
                                descKey: "rec_appsvc_app_packing_desc",
                                params: { cpu: 6.4 },
                            ...
                            },
                            {
                                ...
                                titleKey: "rec_appsvc_modernize_sku_title",
                                descKey: "rec_appsvc_modernize_sku_desc",
                                params: { tier: "Standard S1" },
                        ...
                        remediationActions: [
                            {
                                ...
                                titleKey: "rec_appsvc_zombie_plan_title",
                                descKey: "rec_appsvc_zombie_plan_desc",
                                monthlySavingsUsd: 79.51,
                                risk: "low" as const,
                                confidence: "high" as const,
                        ...
                        remediationActions: [
                            {
                                ...
                                titleKey: "rec_appsvc_scale_workers_title",
                                descKey: "rec_appsvc_scale_workers_desc",
                                params: { workers: 2 },
                            ...
                            },
                            {
                                ...
                                titleKey: "rec_appsvc_idle_slots_title",
                                descKey: "rec_appsvc_idle_slots_desc",
                                params: { slots: 1 },
                        ...
                        remediationActions: [
                            {
                                ...
                                titleKey: "rec_appsvc_modernize_sku_title",
                                descKey: "rec_appsvc_modernize_sku_desc",
                                params: { tier: "Windows Standard S2" },
                        ...
                        remediationActions: [
                            {
                                ...
                                titleKey: "rec_func_downgrade_consumption_title",
                                descKey: "rec_func_downgrade_consumption_desc",
                                params: { plan: "Elastic Premium (EP1)", executions: "14.2k" },
                        ...
                        remediationActions: [
                            {
                                ...
                                titleKey: "rec_func_telemetry_sampling_title",
                                descKey: "rec_func_telemetry_sampling_desc",
                        ...
                        remediationActions: [
                            {
                                ...
                                titleKey: "rec_func_zombie_app_title",
                                descKey: "rec_func_zombie_app_desc",
                                monthlySavingsUsd: 79.51,
                                risk: "low" as const,
                                confidence: "high" as const,
                        ...
                        remediationActions: [
                            {
                                ...
                                titleKey: "rec_func_storage_polling_title",
                                descKey: "rec_func_storage_polling_desc",
                        ...
                        remediationActions: [
                            {
                                ...
                                titleKey: "rec_vm_rightsizing_sku_title",
                                descKey: "rec_vm_rightsizing_sku_desc",
                                params: { targetSku: "Standard_B2s", cpu: 1.2, mem: 11.5, sku: "D4ds_v4" },
                            ...
                            },
                            {
                                ...
                                type: "ahub" as const,
                                titleKey: "rec_vm_ahub_title",
                                descKey: "rec_vm_ahub_desc",
                        ...
                        remediationActions: [
                            {
                                ...
                                titleKey: "rec_vm_deallocated_disk_title",
                                descKey: "rec_vm_deallocated_disk_desc",
                                params: { diskGb: 128 },
                        ...
                        remediationActions: [
                            {
                                ...
                                titleKey: "rec_vm_power_schedule_title",
                                descKey: "rec_vm_power_schedule_desc",
                                params: { rg: "rg-rpa-testing" },
                        ...
                        remediationActions: [
                            {
                                ...
                                titleKey: "rec_vm_abandoned_vm_title",
                                descKey: "rec_vm_abandoned_vm_desc",
        ...
        // v2: las recomendaciones pasaron de traer la frase armada a traer claves
        // i18n + params. Un payload v1 cacheado no tiene titleKey/descKey y el
        // tablero mostraría tarjetas sin título hasta que expire el TTL.
        const cacheKey = `compute:workloads:v2:${tenantId}:${family}`;
            ...
            if (family === "webapps") {
                ...
                if (numberOfWorkers > 1 && (cpuAvg === null || cpuAvg < 20)) {
                    actions.push({
                        ...
                        titleKey: "rec_appsvc_scale_workers_title",
                        descKey: "rec_appsvc_scale_workers_desc",
                        params: { workers: numberOfWorkers },
            ...
            if (family === "functions") {
                ...
                if (isOverprovisioned) {
                    actions.push({
                        ...
                        titleKey: "rec_func_downgrade_consumption_title",
                        descKey: "rec_func_downgrade_consumption_desc",
                        params: { plan: planInfo.hostingPlan, executions: executionCount },
            ...
            if (family === "vms") {
                ...
                if (powerState === "running" && cpuAvg < 10 && memoryInUsePercent < 30 && totalCostMonthlyUsd > 20) {
                    ...
                    actions.push({
                        ...
                        titleKey: "rec_vm_rightsizing_sku_title",
                        descKey: "rec_vm_rightsizing_sku_desc",
                        params: { targetSku, cpu: cpuAvg, mem: memoryInUsePercent, sku },
                        targetSku,
                ...
                if (powerState === "running" && (rgLower.includes("dev") || rgLower.includes("test") || rgLower.includes("qa") || rgLower.includes("staging")) && computeCostMonthlyUsd > 30) {
                    actions.push({
                        ...
                        titleKey: "rec_vm_power_schedule_title",
                        descKey: "rec_vm_power_schedule_desc",
                        params: { rg: resource.resourceGroup },
