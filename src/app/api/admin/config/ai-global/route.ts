...
export async function GET(request: NextRequest) {
    try {
        ...
        return NextResponse.json({
            ...
            endpoint: map.ai_endpoint || "",
            deployment: map.ai_deployment || "gpt-4o-mini",
            enterpriseProvider: map.enterprise_ai_provider || "azure_openai",
            hasEnterpriseApiKey: Boolean(map.enterprise_ai_api_key),
            enterpriseEndpoint: map.enterprise_ai_endpoint || "",
            enterpriseResourceName: map.enterprise_ai_resource_name || "",
            enterpriseDeployment: map.enterprise_ai_deployment || "gpt-5.1",
