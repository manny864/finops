/**
 * Endpoint para Reconocer una Alerta del Sistema (SuperAdmin).
...
import { acknowledgePerformanceAlert } from "@/services/loadTesting.service";
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
    try {
        ...
        const result = await acknowledgePerformanceAlert(id, email, isMock);
