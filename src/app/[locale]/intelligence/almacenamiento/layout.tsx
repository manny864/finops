...
export default async function AlmacenamientoLayout({ children }: { children: ReactNode }) {
    ...
    const tabs = [
        ...
        { href: "/intelligence/almacenamiento/mdisk", label: t("tabManagedDiskFinopsCmp"), icon: <HardDrive className="w-4 h-4 text-[#0054A6]" /> },
        ...
        { href: "/intelligence/almacenamiento/adls2", label: t("tabDataLakeFinopsCmp"), icon: <Database className="w-4 h-4 text-[#0054A6]" /> },
    ];
