    ...
    <div className="content animate-in fade-in px-6 py-8">
      ...
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-2">
          <HardDrive className="w-5 h-5 text-[#0054A6]" />
          {t("managedDiskFinopsTitle")}
        </h2>
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">{t("managedDiskFinopsSubtitle")}</p>
      </div>
      <StorageFinopsCmpBoard family="managed-disks" />
    </div>
  );
}
