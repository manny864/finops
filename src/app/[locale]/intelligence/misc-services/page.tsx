...
import { Blocks, DollarSign, Layers } from 'lucide-react';
...
export default function MiscServicesPage() {
    const t = useTranslations('MiscServices');
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            try {
                ...
                const url = new URL(`/api/intelligence/misc-services`, window.location.origin);
        ...
        <div className="p-6 max-w-5xl mx-auto animate-in fade-in duration-500">
            ...
            <div className="mb-6">
                <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white flex items-center gap-3">
                    <Blocks className="w-8 h-8 text-brand-deep" />
                    {t('page_title')}
                </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-200 dark:border-slate-800 p-6">
                    <h3 className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2 flex items-center gap-1"><Layers className="w-4 h-4" />{t('kpi_service_count')}</h3>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-200 dark:border-slate-800 p-6">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr>
                                <th className="py-3 px-4 border-b border-gray-200 dark:border-slate-700 font-bold text-xs text-gray-500 uppercase">{t('col_service')}</th>
