    ...
    return (
        <div className="content animate-in fade-in">
            <div className="vhead">
                <div>
                    <div className="vt">
                        ...
                        Green FinOps (Sustainability)
                    </div>
                    <div className="vs">Track your cloud carbon footprint and avoided emissions</div>
                </div>
            </div>
            ...
            <div className="grid-3 mb-6">
                <div className="card">
                    <div className="p-5 flex items-center justify-between">
                        <div>
                            <p className="text-grey text-[11px] font-bold uppercase tracking-wider mb-1">Total Carbon Footprint</p>
                ...
                <div className="card">
                    <div className="p-5 flex items-center justify-between">
                        <div>
                            <p className="text-grey text-[11px] font-bold uppercase tracking-wider mb-1">Avoided Emissions</p>
                ...
                <div className="card">
                    <div className="p-5 flex items-center justify-between">
                        <div>
                            <p className="text-grey text-[11px] font-bold uppercase tracking-wider mb-1">Avg Power Efficiency</p>
                            <h3 className="text-ink font-heading font-extrabold text-2xl">High <span className="text-sm font-normal text-ink-soft">Grade</span></h3>
                        </div>
            ...
            <div className="card p-6 flex flex-col items-center justify-center h-64 text-center">
                ...
                <h4 className="text-lg font-bold text-ink mb-2">Sustainable Cloud Computing</h4>
                <p className="text-ink-soft max-w-md">Your carbon intensity factor is automatically mapped to your active Azure regions. Moving workloads to regions like <code>northeurope</code> or <code>francecentral</code> can significantly reduce your footprint.</p>
            </div>
        </div>
    );
}
