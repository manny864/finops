                        ...
                        <div className="p-6 flex-1">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    >
                                        <option value="" className="bg-white dark:bg-slate-800 text-gray-900 dark:text-white">Selecciona una suscripción...</option>
                                        {subscriptions.map((s:any) => <option key={s.id} value={s.id} className="bg-white dark:bg-slate-800 text-gray-900 dark:text-white">{s.displayName}</option>)}
                                    </select>
                                </div>
                                <div>
                                    ...
                                    >
                                        <option value="" className="bg-white dark:bg-slate-800 text-gray-900 dark:text-white">{loadingRgs ? 'Cargando...' : 'Selecciona un RG...'}</option>
                                        {rgs.map((r:any) => <option key={r.name} value={r.name} className="bg-white dark:bg-slate-800 text-gray-900 dark:text-white">{r.name} ({r.location})</option>)}
                                    </select>
                                </div>
                            </div>
                        </div>
