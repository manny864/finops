  ...
  const backups: OrphanBackupItem[] = [
    {
      ...
      formattedLastBackup: "hace 45 días",
      isSoftDeleted: false,
    ...
    },
    {
      ...
      formattedLastBackup: "hace 90 días",
      isSoftDeleted: false,
    ...
    },
    {
      ...
      formattedLastBackup: "hace 20 días",
      isSoftDeleted: false,
    ...
    },
    {
      ...
      formattedLastBackup: "hace 120 días",
      isSoftDeleted: false,
          ...
          for (const item of items) {
            ...
            if (isOrphan || props.protectionState === "ProtectionStopped") {
              ...
              foundBackups.push({
                ...
                formattedLastBackup: props.lastRecoveryPoint ? new Date(props.lastRecoveryPoint).toLocaleDateString("es-ES") : "Desconocido",
