...
const SKU_CATALOG: Record<string, SkuInfo> = {
    ...
    ENTRA_ID_GOVERNANCE: { name: "Microsoft Entra ID Governance", monthlyListPrice: 7 },
    Microsoft_Entra_ID_Governance: { name: "Microsoft Entra ID Governance", monthlyListPrice: 7 },
    WORKLOAD_IDENTITIES: { name: "Microsoft Entra Workload ID", monthlyListPrice: 3 },
    Microsoft_Entra_Workload_Identities: { name: "Microsoft Entra Workload ID", monthlyListPrice: 3 },
