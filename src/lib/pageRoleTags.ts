...
export const PAGE_ROLE_TAGS: Record<string, RoleTag[]> = {
    ...
    "/intelligence/computo/kubernetes": ["FinOps", "CloudAdmin"],
    "/intelligence/container-apps": ["FinOps"],
    "/intelligence/cosmos-db": ["FinOps"],
    "/cleanup/backup-orphans": ["FinOps"],
    "/intelligence/defender": ["FinOps"],
    "/intelligence/seguridad": ["Security", "CloudAdmin"],
    "/intelligence/app-insights": ["FinOps"],
    "/intelligence/monitoreo": ["FinOps", "CloudAdmin"],
    ...
    "/intelligence/almacenamiento": ["FinOps", "CloudAdmin"],
    ...
    "/intelligence/analitica-avanzada": ["FinOps", "CloudAdmin", "Security", "ProductOwner"],
    ...
    "/superadmin/affiliates": ["Platform"],
