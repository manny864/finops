...
export const ADDON_CATALOG: Record<string, AddonProduct> = {
    ...
    mod_integration: {
        ...
        requiredTierFallback: "Enterprise",
        prices: {
            monthly: process.env.PADDLE_PRICE_INTEGRATION_MONTHLY || "",
            pass1m: process.env.PADDLE_PRICE_INTEGRATION_1M || "",
            pass3m: process.env.PADDLE_PRICE_INTEGRATION_3M || "",
            pass6m: process.env.PADDLE_PRICE_INTEGRATION_6M || "",
            pass9m: process.env.PADDLE_PRICE_INTEGRATION_9M || "",
    ...
    mod_monitoring: {
        ...
        requiredTierFallback: "Enterprise",
        prices: {
            monthly: process.env.PADDLE_PRICE_MONITORING_MONTHLY || "pri_01m2bztxw50haynfejjndv0gm1",
            pass1m: process.env.PADDLE_PRICE_MONITORING_1M || "pri_01m2bzvc8asn68rnsstmzjarep",
            pass3m: process.env.PADDLE_PRICE_MONITORING_3M || "pri_01m2bzvvkjs6bp90bf8em367mz",
            pass6m: process.env.PADDLE_PRICE_MONITORING_6M || "pri_01m2bzxynj9yp00vfw3eekangr",
            pass9m: process.env.PADDLE_PRICE_MONITORING_9M || "pri_01m2bzygd0t9a7dhxz3dhr46b3",
            annual: process.env.PADDLE_PRICE_MONITORING_YEARLY || "",
            pass12m: process.env.PADDLE_PRICE_MONITORING_YEARLY || "",
        },
        basePriceUSD: {
            monthly: 129.0,
            pass1m: 129.0,
