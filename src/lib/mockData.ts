...
export function getMockDataForRoute(route: string, arg2: string, locale?: string): any {
    ...
    switch (route) {
        ...
        case 'storage-efficiency': {
            ...
            // Izados porque `params` no puede referenciar `estimatedSavingsUSD`
            // desde dentro del mismo objeto literal.
            const ahorroLifecycle = parseFloat((0.0044 * multiplier).toFixed(4));
            const ahorroRedundancia = parseFloat((0.003 * multiplier).toFixed(4));
            ...
            const remediations = [
                {
                    ...
                    params: { account: accounts[0].name, savings: ahorroLifecycle },
                    category: "Cost",
                    actionType: "LIFECYCLE_POLICY_CREATE",
                    severity: "HIGH",
                    confidence: "HIGH",
                    estimatedSavingsUSD: ahorroLifecycle,
                ...
                },
                {
                    ...
                    params: { account: accounts[2].name, env: "STAGING", redundancy: "ZRS", pct: 33, savings: ahorroRedundancia },
                    category: "Cost",
                    actionType: "REDUNDANCY_OPTIMIZE_LRS",
                    severity: "MEDIUM",
                    confidence: "HIGH",
                    estimatedSavingsUSD: ahorroRedundancia,
                ...
                },
                {
                    ...
                    params: { account: accounts[2].name },
                    category: "Governance",
                ...
                },
                {
                    ...
                    descKey: "rec_sto_security_desc_public",
        ...
        case 'rightsizing':
            return {
                ...
                mock: true,
                data: [
                    { id: "/subscriptions/mock-sub/resourceGroups/prod-rg/providers/Microsoft.Compute/virtualMachines/app-prod-vm-01", name: "app-prod-vm-01", subscriptionId: "mock-sub", currentSku: "Standard_D8s_v3", recommendedSku: "Standard_D4s_v3", savings: 215.50, maxCpu: 8.2, hiddenCost: 0, action: "DOWNGRADE", reason: "Oversized" },
                    // Las dos de abajo son los casos de SUBIDA: una saturada de
                    // forma sostenida (p95 alto) y otra que pega contra el techo
                    // con un piso ya alto. Sin ellas la demo solo mostraba bajadas.
                    { id: "/subscriptions/mock-sub/resourceGroups/prod-rg/providers/Microsoft.Compute/virtualMachines/api-gateway-vm-01", name: "api-gateway-vm-01", subscriptionId: "mock-sub", currentSku: "Standard_D4s_v5", recommendedSku: "Standard_D8s_v5", savings: 0, maxCpu: 99.4, hiddenCost: 0, action: "UPGRADE", reason: "Saturated" },
                    { id: "/subscriptions/mock-sub/resourceGroups/data-rg/providers/Microsoft.Compute/virtualMachines/etl-spark-node-03", name: "etl-spark-node-03", subscriptionId: "mock-sub", currentSku: "Standard_E8s_v5", recommendedSku: "Standard_E16s_v5", savings: 0, maxCpu: 97.1, hiddenCost: 0, action: "UPGRADE", reason: "Peaking" },
                    { id: "/subscriptions/mock-sub/resourceGroups/stage-rg/providers/Microsoft.Compute/virtualMachines/db-stage-vm-02", name: "db-stage-vm-02", subscriptionId: "mock-sub", action: "DOWNGRADE", currentSku: "Standard_E8s_v4", recommendedSku: "Standard_E2s_v4", savings: 380.00, maxCpu: 4.1, hiddenCost: 0, reason: "Low CPU utilization" },
                    { id: "/subscriptions/mock-sub/resourceGroups/batch-rg/providers/Microsoft.Compute/virtualMachines/worker-batch-10", name: "worker-batch-10", subscriptionId: "mock-sub", action: "DOWNGRADE", currentSku: "Standard_F16s_v2", recommendedSku: "Standard_F8s_v2", savings: 412.20, maxCpu: 18.5, hiddenCost: 0, reason: "Low CPU utilization" },
                    { id: "/subscriptions/mock-sub/resourceGroups/core-rg/providers/Microsoft.Compute/virtualMachines/cache-node-01", name: "cache-node-01", subscriptionId: "mock-sub", action: "DOWNGRADE", currentSku: "Standard_D4ds_v5", recommendedSku: "Standard_D2ds_v5", savings: 105.80, maxCpu: 12.0, hiddenCost: 0, reason: "Low CPU utilization" },
                    { id: "/subscriptions/mock-sub/resourceGroups/cscs-finops-prod-westus2-backup-rg/providers/Microsoft.Compute/virtualMachines/vm-mysql-worker", name: "vm-mysql-worker", subscriptionId: "mock-sub", action: "DELETE", currentSku: "Standard_D2s_v5", recommendedSku: "Snapshot & Delete VM", savings: 0, maxCpu: 0, hiddenCost: 38.50, reason: "Deallocated VM with attached Storage", isExempted: true, exemptionReason: "VM requerida para backups periódicos de MySQL", exemptionComment: "Máquina virtual encendida por ventanas cortas según scheduler para respaldar bases de datos en Storage Account. Mantener aunque figure apagada." },
                    { id: "/subscriptions/mock-sub/resourceGroups/legacy-rg/providers/Microsoft.Compute/virtualMachines/old-deallocated-vm", name: "old-deallocated-vm", subscriptionId: "mock-sub", action: "DELETE", currentSku: "Standard_D2s_v3", recommendedSku: "DELETE", savings: 0, maxCpu: 0, hiddenCost: 38.50, reason: "Deallocated VM with attached Storage", isExempted: false }
                ],
        ...
        case 'zero_cost':
            return {
                success: true,
                data: [
                    { id: "/subscriptions/demo/resourceGroups/rg-webapp/providers/Microsoft.Web/serverfarms/asp-frontend-free", name: "asp-frontend-free", type: "microsoft.web/serverfarms", resourceGroup: "rg-webapp", reasonKey: "freeTier", skuName: "F1" },
                    { id: "/subscriptions/demo/resourceGroups/rg-backend/providers/Microsoft.Web/serverfarms/asp-backend-dev", name: "asp-backend-dev", type: "microsoft.web/serverfarms", resourceGroup: "rg-backend", reasonKey: "freeTier", skuName: "Free" },
                    { id: "/subscriptions/demo/resourceGroups/rg-network/providers/Microsoft.Network/virtualNetworks/vnet-core-hub", name: "vnet-core-hub", type: "microsoft.network/virtualnetworks", resourceGroup: "rg-network", reasonKey: "noBaseCost", skuName: "N/A" },
                    { id: "/subscriptions/demo/resourceGroups/rg-security/providers/Microsoft.Network/networkSecurityGroups/nsg-web-inbound", name: "nsg-web-inbound", type: "microsoft.network/networksecuritygroups", resourceGroup: "rg-security", reasonKey: "noBaseCost", skuName: "N/A" },
                    { id: "/subscriptions/demo/resourceGroups/rg-security/providers/Microsoft.Network/networkSecurityGroups/nsg-db-internal", name: "nsg-db-internal", type: "microsoft.network/networksecuritygroups", resourceGroup: "rg-security", reasonKey: "noBaseCost", skuName: "N/A" }
                ]
            };
        case 'aks':
            return {
        ...
        case 'white_board': {
            ...
            return {
                ...
                quickWins: [
                    { id: "qw-vm", title: "Right-size underutilized virtual machines", category: "Cost", resourceName: "vm-app-prod-03", resourceGroup: "rg-app-prod", resourceType: "Microsoft.Compute/virtualMachines", estimatedMonthlySavingsUSD: round2(1250 * scale), actionType: "RESIZE", description: "Sustained CPU below 10% over the last 30 days.", commandCli: `az vm resize --resource-group "rg-app-prod" --name "vm-app-prod-03" --size "Standard_D4s_v5"`, commandPowerShell: `Update-AzVM -ResourceGroupName "rg-app-prod" -Name "vm-app-prod-03" -Size "Standard_D4s_v5"` },
                    { id: "qw-disk", title: "Delete unattached managed disks", category: "Cost", resourceName: "disk-legacy-backup", resourceGroup: "rg-storage-legacy", resourceType: "Microsoft.Compute/disks", estimatedMonthlySavingsUSD: round2(540 * scale), actionType: "DELETE_DISK", description: "These managed disks are not attached to any virtual machine and continue to incur storage costs. Delete them to save costs.", commandCli: `az disk delete --resource-group "rg-storage-legacy" --name "disk-legacy-backup" --yes`, commandPowerShell: `Remove-AzDisk -ResourceGroupName "rg-storage-legacy" -DiskName "disk-legacy-backup" -Force` },
                    { id: "qw-tags", title: "Assign CostCenter to untagged resources", category: "Governance", resourceName: "rg-shared-services", resourceGroup: "rg-shared-services", resourceType: "Microsoft.Resources/resourceGroups", estimatedMonthlySavingsUSD: 0, actionType: "OPTIMIZE", description: "Unallocated cost prevents reliable showback and chargeback.", commandCli: `az tag update --resource-id "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-shared-services" --operation Merge --tags CostCenter="Infrastructure" Environment="Production"`, commandPowerShell: `Update-AzTag -ResourceId "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-shared-services" -Tag @{ CostCenter = "Infrastructure"; Environment = "Production" } -Operation Merge` },
                ],
                ...
                securityActions: [
                    ...
                    "Restrict internet-exposed resources with network security groups",
...
export function getAiSearchMockPayload(tenantId: string): AiSearchPayload {
  ...
  const remediationActions: AiSearchRemediationAction[] = [
    {
      ...
      params: { name: "search-dev-westus", gb: "1.2", savings: "172.00" },
    ...
    },
    {
      ...
      params: { name: "search-orphan-legacy", cost: "245.00" },
  ...
  if (tier === "enterprise") {
    remediationActions.push({
      ...
      params: { name: "search-staging-eastus", gb: "0.8", savings: "172.00" },
      category: "DOWNGRADE_TIER",
      estimatedSavingsUSD: "172.00",
      confidence: "HIGH",
      actionType: "SKU_CHANGE",
