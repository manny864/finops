    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex gap-1 border-b border-gray-200 dark:border-slate-800">
                <button onClick={() => setTab("dashboard")} className={`relative flex items-center gap-1.5 px-3.5 py-2 text-sm font-bold border-b-2 transition-colors ${tab === "dashboard" ? "border-brand-deep text-brand-deep dark:text-brand-bright bg-brand-soft/70 dark:bg-brand-deep/10" : "border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"}`} aria-pressed={tab === "dashboard"}><Package className="w-4 h-4" /> {t("tab_dashboard")}{tab === "dashboard" && <span className="absolute -bottom-[1px] left-1/2 h-1.5 w-1.5 -translate-x-1/2 rounded-full bg-brand-deep dark:bg-brand-bright" />}</button>
                <button onClick={() => setTab("activity")} className={`relative flex items-center gap-1.5 px-3.5 py-2 text-sm font-bold border-b-2 transition-colors ${tab === "activity" ? "border-brand-deep text-brand-deep dark:text-brand-bright bg-brand-soft/70 dark:bg-brand-deep/10" : "border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"}`} aria-pressed={tab === "activity"}><Users className="w-4 h-4" /> {t("tab_user_activity")}{tab === "activity" && <span className="absolute -bottom-[1px] left-1/2 h-1.5 w-1.5 -translate-x-1/2 rounded-full bg-brand-deep dark:bg-brand-bright" />}</button>
                <button onClick={() => setTab("licenseopt")} className={`relative flex items-center gap-1.5 px-3.5 py-2 text-sm font-bold border-b-2 transition-colors ${tab === "licenseopt" ? "border-brand-deep text-brand-deep dark:text-brand-bright bg-brand-soft/70 dark:bg-brand-deep/10" : "border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"}`} aria-pressed={tab === "licenseopt"}><Cpu className="w-4 h-4" /> {t("tab_license_optimization")}{tab === "licenseopt" && <span className="absolute -bottom-[1px] left-1/2 h-1.5 w-1.5 -translate-x-1/2 rounded-full bg-brand-deep dark:bg-brand-bright" />}</button>
            </div>
