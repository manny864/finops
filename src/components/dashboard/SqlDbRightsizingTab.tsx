...
export default function SqlDbRightsizingTab() {
    ...
    if (isLoading) return (
        <div className="flex items-center justify-center py-16">
            ...
            <span className="text-gray-500">Cargando recomendaciones SQL DB...</span>
        </div>
    );
        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 border border-blue-100 dark:border-blue-900/40">
                    <p className="text-xs text-blue-600 dark:text-blue-400 font-semibold uppercase tracking-wide">DBs Analizadas</p>
                ...
                <div className="bg-violet-50 dark:bg-violet-900/20 rounded-xl p-4 border border-violet-100 dark:border-violet-900/40">
                    <p className="text-xs text-violet-600 dark:text-violet-400 font-semibold uppercase tracking-wide">DTU Prom. Mínimo</p>
            ...
            <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-xl p-3">
                <input
                    ...
                    placeholder="Buscar servidor, BD, tier..."
            ...
            <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-xl shadow-sm overflow-x-auto">
                <table className="w-full text-left text-sm">
                    <thead className="bg-gray-50 dark:bg-slate-800/50 text-xs text-slate-500 dark:text-slate-400">
                        <tr>
                            <th className="px-4 py-3 font-semibold">Servidor / BD</th>
                            <th className="px-4 py-3 font-semibold">Tier Actual</th>
                            <th className="px-4 py-3 font-semibold">Tier Recom.</th>
                            <th className="px-4 py-3 font-semibold text-center">DTU Prom.</th>
                    ...
                    <tbody className="divide-y divide-gray-100 dark:divide-slate-800/50">
                        ...
                        {filtered.length === 0 && (
                            <tr><td colSpan={7} className="px-4 py-10 text-center text-sm text-slate-500">No hay recomendaciones SQL DB.</td></tr>
                        )}
                    </tbody>
                </table>
            </div>
