...
const tw = useTranslations("WafSecurity");
  const t = useTranslations("WafSecurity");
  const tc = useTranslations("Common");
  const textoRem = useTextoPorCategoria("WafSecurity");
            ...
            {summary.threatsBreakdown.map((t) => (
              ...
              >
                <div className="flex justify-between items-start gap-2">
                  ...
                  >
                    {t.severity === "High" ? tw("sevHigh") : t.severity === "Medium" ? tw("sevMedium") : tw("sevLow")}
                  </span>
                </div>
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-[10px] text-slate-500 dark:text-slate-400">
                    {tw("attempts")}{t.crsRulePrefix ? ` · CRS ${t.crsRulePrefix}xxx` : ""}
                  </span>
                </div>
                <div className="space-y-1">
