...
export function evaluateAroRemediations(
    ...
    if (isDevTest && isAutoscalerInactive) {
        ...
        actions.push({
            ...
            titleKey: "rec_aro_enable_autoscaler_title",
            descKey: "rec_aro_enable_autoscaler_desc",
    ...
    if (isDevTest && cluster.cpuAvg !== null && cluster.cpuAvg < 20 && !actions.some((a) => a.type === "consolidate_cluster")) {
        ...
        actions.push({
            ...
            titleKey: "rec_aro_consolidate_cluster_title",
            descKey: "rec_aro_consolidate_cluster_desc",
            params: { cluster: cluster.name, cpu: cluster.cpuAvg, cost: masterBaseCost },
    ...
    if (cluster.cpuAvg !== null && cluster.cpuAvg < 25 && cluster.memoryAvgPercent !== null && cluster.memoryAvgPercent < 35) {
        ...
        actions.push({
            ...
            titleKey: "rec_aro_rightsizing_workers_title",
            descKey: "rec_aro_rightsizing_workers_desc",
            params: { currentSku, cpu: cluster.cpuAvg, mem: cluster.memoryAvgPercent, targetSku },
    ...
    if (!isDevTest && cluster.cpuAvg !== null && cluster.cpuAvg >= 40) {
        ...
        actions.push({
            ...
            type: "savings_plan",
            titleKey: "rec_aro_savings_plan_title",
            descKey: "rec_aro_savings_plan_desc",
    ...
    if (cluster.orphanPvcCount > 0) {
        actions.push({
            ...
            type: "orphan_pvc",
            titleKey: "rec_aro_orphan_pvc_title",
            descKey: "rec_aro_orphan_pvc_desc",
            params: { count: cluster.orphanPvcCount },
