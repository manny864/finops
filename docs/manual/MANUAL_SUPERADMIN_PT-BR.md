...
- **CronJobs de Pré-aquecimento Ativos:** Implantação dos Container App Jobs `prewarm-compute`, `prewarm-databases` e `prewarm-mysql-finops` com alertas de métricas no Azure Monitor.
