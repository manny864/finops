...
3. **Tag commercial origin (optional):** in the expanded panel for each tenant in the Environments Directory, the **"Commercial Origin / Referred by"** field lets you note which salesperson sold or referred the client — only visible to SuperAdmins.
