...
Se você se cadastrou sozinho pela página de preços (sem passar por um onboarding assistido pela equipe da CSCloudSolutions), sua conta começa com um **teste de 14 dias** no plano que você escolheu. Você verá um banner de status do teste no topo da plataforma:
