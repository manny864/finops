...
- **Prewarm CronJobs Activos:** Despliegue de los Container App Jobs `prewarm-compute`, `prewarm-databases` y `prewarm-mysql-finops` con alertas de métricas en Azure Monitor.
