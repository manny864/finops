...
Si te registraste vos mismo desde la página de precios (sin pasar por onboarding de un SuperAdmin), tu cuenta arranca con un **trial de 14 días** sobre el plan que elegiste. Vas a ver un banner de estado del trial en la parte superior de la plataforma:
