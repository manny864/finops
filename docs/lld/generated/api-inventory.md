...
| `/api/admin/config/users` | GET, POST, PUT, DELETE | requireSuperAdmin, requireTenantAccess, requireRequestIdentity | — | — |
...
| `/api/intelligence/ai-analytics` | GET | requireTenantAccess | — | sí |
