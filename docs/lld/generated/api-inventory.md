...
| `/api/notifications` | GET, PATCH, DELETE | requireTenantAccess | — | sí |
| `/api/notifications/mark-read` | PATCH | requireTenantAccess | — | sí |
...
| `/api/superadmin/load-test/run` | POST | requireSuperAdmin | — | — |
| `/api/superadmin/load-test/runs` | GET | requireSuperAdmin | — | — |
...
| `/api/tenants/[tenantId]/tier-limits` | GET | requireTenantAccess | — | sí |
